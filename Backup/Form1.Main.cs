...
namespace Tao_Framework_Meet
{
    public partial class Form0 : Form
    {
        ...
        public List<Cube> Model = new List<Cube>();
        ...
        {
            try {
                //txtMouseX.Text = selectedEdge_.lockState.lockStatus.ToString();
                //txtMouseY.Text = selectedEdge_.lockState.enableChange.ToString();
            }
            catch { }
        ...
        void DefineScaledShapes(int type)
        {
            ...
            {
                //textBox1.Text = "allright";
                scaledShapes.Add(RemovingCube);
            }

            //MessageBox.Show("for scale "+
