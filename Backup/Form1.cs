...
namespace Tao_Framework_Meet
{
    public partial class Form0 : Form
    {
        ...
        private void btnTryScale_Click(object sender, EventArgs e)
        {
            ...
            Form2 frmPrimitiveDesigner = new Form2();
            frmPrimitiveDesigner.frmParent = this;
            frmPrimitiveDesigner.Show();
        }
        ...
        public bool isSelectForScale = false;

        private void toolStripButton1_Click_1(object sender, EventArgs e)
        {
            isSelectForScale = !isSelectForScale;
        }
       ...
       /* private void textBoxCoord_KeyDown(object sender, KeyEventArgs e)
        ...
        public Cube newPrimitive_ = new Cube();
        public List<Cube> primitives = new List<Cube>();
